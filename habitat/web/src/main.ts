...
const commands: Command[] = [
  ...
  { id: "debug-construct", title: "Debug construct", group: "Debug", description: "Force a construction plan for diagnostics.", method: "POST", path: "/commands/construct", fields: [{ name: "blueprintId", label: "Blueprint ID", placeholder: "greenhouse" }, { name: "dryRun", label: "Dry run (true/false)", placeholder: "true" }] },
